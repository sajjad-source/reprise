...
// Icons as simple SVGs for minimal dependencies
const Icons = {
  home: () => (
...
const navigation = [
  ...
  { name: "Content", href: "/dashboard/content", icon: Icons.upload },
  { name: "Experiments", href: "/dashboard/experiments", icon: Icons.beaker },
  { name: "Schedule", href: "/dashboard/schedule", icon: Icons.calendar },
  { name: "Insights", href: "/dashboard/insights", icon: Icons.chart },
];
